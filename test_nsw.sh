...
curl -i -X GET "http://localhost:1492/sifxml/kla2timetablesubject?kla=French&yrlvl=10"
curl -i -H "Accept: application/json" -X GET "http://localhost:1492/sifxml/kla2timetablesubject?kla=French&yrlvl=10"
curl -i -X GET "http://localhost:1492/sifxml/kla2teachinggroup?kla=French&yrlvl=10"
curl -i -H "Accept: application/json" -X GET "http://localhost:1492/sifxml/kla2teachinggroup?kla=French&yrlvl=10"
